...
### 19. 热力学性质估算的思路
> thermodynamic-property evaluation is most conveniently accomplished in two steps: first, calculation of values for a hypothetical ideal-gas state wherein ideal-gas heat capacities are used; second, correction of the ideal-gas-state values to the real-gas values. 
> 
