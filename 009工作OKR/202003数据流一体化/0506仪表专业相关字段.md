...
ALTER TABLE `ks_types` MODIFY COLUMN `temp_mark_graduation` varchar(120) DEFAULT NULL COMMENT '温度计分度号';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_sensor_diameter` varchar(120) DEFAULT NULL COMMENT '温度计传感器直径';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_sensor_style` varchar(120) DEFAULT NULL COMMENT '温度计传感器形式';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_prot_diameter` varchar(120) DEFAULT NULL COMMENT '温度计保护套直径';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_prot_material` varchar(120) DEFAULT NULL COMMENT '温度计保护套材质';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_prot_style` varchar(120) DEFAULT NULL COMMENT '温度计保护套形式';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_well_diameter` varchar(120) DEFAULT NULL COMMENT '温度计套管直径';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_well_style` varchar(120) DEFAULT NULL COMMENT '温度计套管形式';
ALTER TABLE `ks_types` MODIFY COLUMN `temp_well_material` varchar(120) DEFAULT NULL COMMENT '温度计套管材质';



ALTER TABLE `ks_types` ADD COLUMN `created_at` int DEFAULT NULL COMMENT '创建时间';
ALTER TABLE `ks_types` ADD COLUMN `updated_at` int DEFAULT NULL COMMENT '更新时间';
ALTER TABLE `ks_types` ADD COLUMN `deleted_at` int DEFAULT NULL COMMENT '删除时间';
